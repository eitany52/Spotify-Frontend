...
import { addSongToStation, getUserStations, isSongSavedAtStation, removeSongFromStation } from "../store/actions/station.actions.js";
...
export const FloatingMenuSongAdd = ({ song, onDone }) => {
  ...
  function removeStation(setStations, stationId) {
    setStations(stations => stations.filter(station => station._id !== stationId))
  }
  ...
  return (
    <form onSubmit={onToggleAddSongToStations} className="floating-menu-song-add">
      <ul>
